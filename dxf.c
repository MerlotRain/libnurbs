...
struct hash_table       *
hashtab_create(uint32_t (*hash)(struct hash_table *, void *),
                     int32_t (*compare)(struct hash_table *, void *key1, void *key2),
                     int32_t size);
...
void write_point(dxf_document_t *doc,
                 dxf_write_t    *w,
                 dxf_point_data *data,
                 dxf_attributes *attr) {}

void write_line(dxf_document_t *doc,
                dxf_write_t    *w,
                dxf_line_data  *data,
                dxf_attributes *attr) {}

void write_xline(dxf_document_t *doc,
                 dxf_write_t    *w,
                 dxf_xline_data *data,
                 dxf_attributes *attr) {}

void write_ray(dxf_document_t *doc,
               dxf_write_t    *w,
               dxf_ray_data   *data,
               dxf_attributes *attr) {}

void write_polyline(dxf_document_t    *doc,
                    dxf_write_t       *w,
...
void write_spline(dxf_document_t  *doc,
                  dxf_write_t     *w,
                  dxf_spline_data *data,
                  dxf_attributes  *attr) {}

void write_control_point(dxf_document_t         *doc,
                         dxf_write_t            *w,
                         dxf_control_point_data *data) {}

void write_fit_point(dxf_document_t     *doc,
                     dxf_write_t        *w,
                     dxf_fit_point_data *data) {}

void write_knot(dxf_document_t *doc, dxf_write_t *w, dxf_knot_data *data) {}

void write_circle(dxf_document_t  *doc,
                  dxf_write_t     *w,
                  dxf_circle_data *data,
                  dxf_attributes  *attr) {}

void write_arc(dxf_document_t *doc,
               dxf_write_t    *w,
               dxf_arc_data   *data,
               dxf_attributes *attr) {}

void write_ellipse(dxf_document_t   *doc,
                   dxf_write_t      *w,
                   dxf_ellipse_data *data,
                   dxf_attributes   *attr) {}

void write_solid(dxf_document_t *doc,
                 dxf_write_t    *w,
                 dxf_solid_data *data,
                 dxf_attributes *attr) {}

void write_trace(dxf_document_t *doc,
                 dxf_write_t    *w,
                 dxf_trace_data *data,
                 dxf_attributes *attr) {}

void write_3dFace(dxf_document_t   *doc,
                  dxf_write_t      *w,
                  dxf_3d_face_data *data,
                  dxf_attributes   *attr) {}

void write_insert(dxf_document_t  *doc,
                  dxf_write_t     *w,
                  dxf_insert_data *data,
                  dxf_attributes  *attr) {}

void write_mText(dxf_document_t *doc,
                 dxf_write_t    *w,
                 dxf_mText_data *data,
                 dxf_attributes *attr) {}

void write_text(dxf_document_t *doc,
                dxf_write_t    *w,
                dxf_text_data  *data,
                dxf_attributes *attr) {}

void write_attribute(dxf_document_t     *doc,
                     dxf_write_t        *w,
                     dxf_attribute_data *data,
                     dxf_attributes     *attr) {}

void write_dim_style_overrides(dxf_document_t     *doc,
                               dxf_write_t        *w,
                               dxf_dimension_data *data) {}

void write_dim_aligned(dxf_document_t       *doc,
                       dxf_write_t          *w,
                       dxf_dimension_data   *data,
                       dxf_dim_aligned_data *edata,
                       dxf_attributes       *attr) {}

void write_dim_linear(dxf_document_t      *doc,
                      dxf_write_t         *w,
                      dxf_dimension_data  *data,
                      dxf_dim_linear_data *edata,
                      dxf_attributes      *attr) {}

void write_dim_radial(dxf_document_t      *doc,
                      dxf_write_t         *w,
                      dxf_dimension_data  *data,
                      dxf_dim_radial_data *edata,
                      dxf_attributes      *attr) {}

void write_dim_diametric(dxf_document_t         *doc,
                         dxf_write_t            *w,
                         dxf_dimension_data     *data,
                         dxf_dim_diametric_data *edata,
                         dxf_attributes         *attr) {}

void write_dim_angular2L(dxf_document_t         *doc,
                         dxf_write_t            *w,
                         dxf_dimension_data     *data,
                         dxf_dim_angular2L_data *edata,
                         dxf_attributes         *attr) {}

void write_dim_angular3P(dxf_document_t         *doc,
                         dxf_write_t            *w,
                         dxf_dimension_data     *data,
                         dxf_dim_angular3P_data *edata,
                         dxf_attributes         *attr) {}

void write_dim_ordinate(dxf_document_t        *doc,
                        dxf_write_t           *w,
                        dxf_dimension_data    *data,
                        dxf_dim_ordinate_data *edata,
                        dxf_attributes        *attr) {}

void write_leader(dxf_document_t  *doc,
                  dxf_write_t     *w,
                  dxf_leader_data *data,
                  dxf_attributes  *attr) {}

void write_leader_vertex(dxf_document_t         *doc,
                         dxf_write_t            *w,
                         dxf_leader_vertex_data *data) {}

void write_leader_end(dxf_document_t  *doc,
                      dxf_write_t     *w,
                      dxf_leader_data *data) {}

void write_hatch1(dxf_document_t *doc,
                  dxf_write_t    *w,
                  dxf_hatch_data *data,
                  dxf_attributes *attr) {}

void write_hatch2(dxf_document_t *doc,
                  dxf_write_t    *w,
                  dxf_hatch_data *data,
                  dxf_attributes *attr) {}

void write_hatch_loop1(dxf_document_t      *doc,
                       dxf_write_t         *w,
                       dxf_hatch_loop_data *data) {}

void write_hatch_loop2(dxf_document_t      *doc,
                       dxf_write_t         *w,
                       dxf_hatch_loop_data *data) {}

void write_hatch_edge(dxf_document_t      *doc,
                      dxf_write_t         *w,
                      dxf_hatch_edge_data *data) {}

unsigned long write_image(dxf_document_t *doc,
                          dxf_write_t    *w,
                          dxf_image_data *data,
                          dxf_attributes *attr) {
    return 0;
...
void write_image_def(dxf_document_t *doc,
                     dxf_write_t    *w,
                     int             handle,
                     dxf_image_data *data) {}

void write_layer(dxf_document_t *doc,
                 dxf_write_t    *w,
                 dxf_layer_data *data,
                 dxf_attributes *attr) {}

void write_line_type(dxf_document_t     *doc,
                     dxf_write_t        *w,
...
void write_dim_style(dxf_document_t *doc,
                     dxf_write_t    *w,
                     double          dimasz,
                     double          dimexe,
                     double          dimexo,
...
void write_objects(dxf_document_t *doc,
                   dxf_write_t    *w,
...
unsigned long
write_dictionary_entry(dxf_document_t *doc, dxf_write_t *w, const char *name) {
    return 0;
}

void write_x_record_int(dxf_document_t *doc,
                        dxf_write_t    *w,
                        int             handle,
                        int             value) {}

void write_x_record_double(dxf_document_t *doc,
                           dxf_write_t    *w,
                           int             handle,
                           double          value) {}

void write_x_record_BOOL(dxf_document_t *doc,
                         dxf_write_t    *w,
                         int             handle,
                         BOOL            value) {}

void write_x_record_string(dxf_document_t *doc,
                           dxf_write_t    *w,
                           int             handle,
                           const char     *value) {}
